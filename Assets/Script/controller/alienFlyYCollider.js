var sbattuto : boolean = false; //controlla se il nemico sbatte su un'ostacoloi
...
function Update(){
		//Movimento nemici
		var distaProta = Vector3.Distance(GameObject.Find("shuttle").transform.position, this.transform.position);
		if (sbattuto==false){	
