...
var finito : boolean = false; //controlla il sono di completato livello è stato suonato
...
function Update () {
	...
	//Passaggio dell'aereoplano
	GameObject.Find("airplane").transform.position.x-=0.2*Time.deltaTime;
	...
	GameObject.Find("tractor").transform.position.x+=0.2*Time.deltaTime;
}
